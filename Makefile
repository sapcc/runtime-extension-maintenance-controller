...
install: FORCE build/runtime-extension-maintenance-controller
	install -d -m 0755 "$(DESTDIR)$(PREFIX)/bin"
	install -m 0755 build/runtime-extension-maintenance-controller "$(DESTDIR)$(PREFIX)/bin/runtime-extension-maintenance-controller"
...
generate: install-controller-gen
	...
	@controller-gen crd rbac:roleName=runtime-extension-maintenance-controller webhook paths="./..." output:crd:artifacts:config=crd output:rbac:artifacts:config=config/rbac
...
goimports: FORCE install-goimports
	@printf "\e[1;36m>> goimports -w -local https://github.com/sapcc/runtime-extension-maintenance-controller\e[0m\n"
	@goimports -w -local github.com/sapcc/runtime-extension-maintenance-controller $(patsubst $(shell awk '$$1 == "module" {print $$2}' go.mod)%,.%/*.go,$(shell go list ./...))
...
help: FORCE
	...
	@printf "  \e[36mbuild/runtime-extension-maintenance-controller\e[0m  Build runtime-extension-maintenance-controller.\n"
